        ...
        filteredShops.forEach(shop => {
            ...
            card.innerHTML = `
                ...
                <div class="p-3 bg-gray-50 flex gap-2">
                    <button onclick="openDeliverModal('${shop.id}')" class="flex-1 bg-blue-100 hover:bg-blue-200 text-blue-700 py-2 rounded-xl text-sm font-bold shadow-sm transition flex justify-center items-center gap-2"><i class="fa-solid fa-box-open"></i> Put Items</button>
                    <button onclick="openAdminTakeMoneyModal('${shop.id}')" class="flex-1 bg-green-100 hover:bg-green-200 text-green-700 py-2 rounded-xl text-sm font-bold shadow-sm transition flex justify-center items-center gap-2"><i class="fa-solid fa-hand-holding-dollar"></i> Take Money</button>
                </div>
            `;
